...
parameterarray = np.loadtxt("Manual_Norelease", delimiter=",")
...
np.savetxt(f'simulation_NoRelease_MN_Total_{name:03.0f}.csv', stochastic_array, delimiter=",")
np.savetxt(f'simulation_NoRelease_MN_Gens_{name:03.0f}.csv', GenerationMatrix, delimiter=",")
