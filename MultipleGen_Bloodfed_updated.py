...
parameterarray = np.loadtxt("Manual_Bloodfed", delimiter=",")
...
np.savetxt(f'simulation_BloodfedFemales_MN_Total_{name:03.0f}.csv', stochastic_array, delimiter=",")
np.savetxt(f'simulation_BloodfedFemales_MN_Gens_{name:03.0f}.csv', GenerationMatrix, delimiter=",")
